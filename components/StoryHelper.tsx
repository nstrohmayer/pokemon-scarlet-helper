                            ...
                            <form onSubmit={handleAddGoalSubmit} className="flex flex-col gap-2 mb-4">
                                ...
                                <div className="flex gap-2">
                                    <button type="submit" className="flex-1 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-md shadow-sm transition-colors disabled:opacity-50" disabled={!newGoalText.trim() || isAiGoalLoading}>
                                     ...
                                     <button type="button" onClick={handleAddGoalWithAi} className="flex-1 px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white font-semibold rounded-md shadow-sm transition-colors disabled:opacity-50 flex items-center justify-center gap-2" disabled={!newGoalText.trim() || isAiGoalLoading}>
                                        {isAiGoalLoading ? (
                                            <>
